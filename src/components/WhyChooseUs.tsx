...
export default function WhyChooseUs() {
  ...
  return (
    <section id="why-choose-us" className="py-24 bg-white dark:bg-[#0F172A] scroll-mt-10 overflow-hidden relative">
      <div className="absolute left-0 top-0 w-80 h-80 bg-[#11341C]/3 dark:bg-[#8FC14E]/2 rounded-full filter blur-3xl -z-10 translate-y-24"></div>
          ...
          {cards.map((c, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#F8FAF5] dark:bg-[#1E293B] hover:bg-white dark:hover:bg-slate-800/80 rounded-[32px] p-8 border border-neutral-150 dark:border-white/5 hover:border-[#11341C]/25 dark:hover:border-[#8FC14E]/25 shadow-sm hover:shadow-xl transition-all duration-300 relative overflow-hidden group flex flex-col justify-between"
              >
                {/* Subtle glowing overlay background on hover */}
                <div className="absolute top-0 right-0 w-24 h-24 bg-[#11341C]/5 dark:bg-[#8FC14E]/3 rounded-bl-[32px] group-hover:scale-110 transition-transform -z-10"></div>

                <div className="space-y-6">
                  
                  {/* Card Header */}
                  <div className="flex justify-between items-center">
                    <div className="bg-[#11341C] dark:bg-[#8FC14E] text-white dark:text-[#0F172A] p-3.5 rounded-2xl shadow-lg shadow-[#11341C]/10 dark:shadow-none group-hover:rotate-3 transition">
                      <Icon className="h-6 w-6 stroke-[2.2]" />
                    </div>
                    
                    <span className="text-[9px] font-black text-[#11341C] dark:text-[#8FC14E] bg-[#11341C]/8 dark:bg-[#8FC14E]/12 px-3 py-1.5 rounded-lg uppercase tracking-widest leading-none font-heading">
                      {c.badge}
                    </span>
                  </div>
                ...
                <div className="mt-8 flex items-center space-x-2.5 text-[10px] font-black text-[#11341C] dark:text-[#8FC14E] uppercase tracking-wider border-t border-neutral-200/50 dark:border-slate-800/50 pt-4 font-heading">
