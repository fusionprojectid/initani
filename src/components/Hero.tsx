...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-[92vh] flex items-center bg-[#F8FAF5] dark:bg-[#0F172A] pt-12 overflow-hidden">
      
      {/* Absolute decorative background elements for high-end feel */}
      <div className="absolute top-[-20%] right-[-10%] w-[600px] h-[600px] bg-[#0D3B20]/5 dark:bg-[#70A83B]/3 rounded-full filter blur-[100px] -z-10"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            ...
            <motion.div 
              ...
              className="inline-flex items-center space-x-2 bg-white dark:bg-[#1E293B] border border-[#0D3B20]/15 dark:border-white/5 px-4.5 py-2 rounded-full shadow-sm"
            >
              <span className="h-2 w-2 bg-[#0D3B20] dark:bg-[#70A83B] rounded-full animate-pulse"></span>
              <span className="text-[10px] font-black uppercase tracking-widest text-[#0D3B20] dark:text-[#70A83B]">
            ...
            <div className="space-y-4">
              ...
              >
                ...
                Dimulai Dari <span className="text-[#0D3B20] dark:text-[#70A83B] underline decoration-amber-500 dark:decoration-amber-400 decoration-wavy underline-offset-4">Nutrisi Unggul</span>
              </motion.h1>
            ...
            >
              <button
                ...
                className="w-full sm:w-auto bg-[#0D3B20] hover:bg-[#1B5E20] dark:bg-[#70A83B] dark:hover:bg-[#22C55E] text-white dark:text-[#0F172A] px-8 py-4.5 rounded-xl text-xs font-black uppercase tracking-widest shadow-xl shadow-[#0D3B20]/25 dark:shadow-none transition-all duration-200 transform hover:-translate-y-0.5 cursor-pointer"
              >
              ...
              >
                <Calculator className="h-4 w-4 text-[#0D3B20] dark:text-[#70A83B]" />
            ...
            >
              <div className="flex items-center space-x-2">
                <ShieldCheck className="h-5 w-5 text-[#0D3B20] dark:text-[#70A83B] shrink-0" />
                <span>100% Produk Asli</span>
              </div>
              <div className="flex items-center space-x-2">
                <Award className="h-5 w-5 text-[#0D3B20] dark:text-[#70A83B] shrink-0" />
                <span>HET Resmi Penjualan</span>
              </div>
              <div className="flex items-center space-x-2">
                <Sprout className="h-5 w-5 text-[#0D3B20] dark:text-[#70A83B] shrink-0" />
          ...
          <div className="lg:col-span-5 relative w-full flex justify-center">
            ...
            <motion.div 
              ...
              className="w-full max-w-[400px] bg-white dark:bg-[#1E293B] rounded-[40px] shadow-2xl border border-[#0D3B20]/10 dark:border-white/5 p-8 sm:p-9 relative overflow-hidden bg-gradient-to-br from-white to-[#F8FAF5]/40 dark:from-[#1E293B] dark:to-[#0F172A]/40"
            >
              
              {/* Circular green overlay inside the container */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#0D3B20]/5 dark:bg-[#70A83B]/5 rounded-bl-[40px] -z-10"></div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center pb-4 border-b border-gray-150 dark:border-slate-800">
                  <div className="flex items-center space-x-2.5">
                    <div className="bg-[#0D3B20]/10 dark:bg-[#70A83B]/10 p-2 rounded-xl text-[#0D3B20] dark:text-[#70A83B]">
                  ...
                  <span className="text-[10px] bg-[#0D3B20]/8 dark:bg-[#70A83B]/10 text-[#0D3B20] dark:text-[#70A83B] px-3 py-1.5 rounded-lg font-black uppercase tracking-widest">
                    SIREG JATIM
                  </span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-neutral-50 dark:bg-slate-900/40 p-4.5 rounded-2xl border border-gray-150 dark:border-slate-800 flex flex-col justify-center">
                    ...
                    <span className="text-[10px] text-[#0D3B20] dark:text-[#70A83B] font-semibold mt-0.5">09:00 - 17:00</span>
                  </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-[#0D3B20] hover:bg-[#1B5E20] dark:bg-[#70A83B] dark:hover:bg-[#22C55E] text-white dark:text-[#0F172A] py-3.5 px-4 rounded-2xl font-black text-[10.5px] uppercase tracking-widest text-center flex justify-center items-center space-x-2 shadow-lg shadow-[#0D3B20]/10 dark:shadow-none transition"
                >
